...
const negara = async (req, res) => {
    try {
        const data = await service.negara(req.body); 
...
const negaraByNama= async (req, res) => {
    try {
        const { nama } = req.query;
        const data = await service.negaraByNama({ nama }); 
...
const detailPekerjaan = async (req, res) => {
    try {
        const { pekerjaan_id } = req.query;
        const data = await service.detailPekerjaan({pekerjaan_id});
...
const detailJabatanPTK = async (req, res) => {
    try {
        const { jabatan_ptk_id } = req.query;
        const data = await service.detailJabatanPTK({jabatan_ptk_id});
